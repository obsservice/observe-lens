...
from observelens_agent.agent.subgraphs.cmd import build_cmd_subgraph
from observelens_agent.agent.subgraphs.qa import build_qa_subgraph
from observelens_agent.agent.subgraphs.rca import build_rca_subgraph
...
def build_agent_graph(
    ...
    rca_subgraph = build_rca_subgraph(knowledge_client, catalog_client, gateway_client)
